...
# 2. Download NLCD 1992 land cover layer
# ----------------------------------------
#this wouldnt work using FedData package (too outdated)
#I am instead going to manually download LNCD land cover layers from:https://www.mrlc.gov/viewer/ 
# After downloading NLCD (e.g., 1992) from MRLC, unzip it and locate the .img or .tif file
nlcd_1998_path <- "/Users/whitneymaxfield/Downloads/Annual_NLCD_LndCov_1998_CU_C1V1/Annual_NLCD_LndCov_1998_CU_C1V1.tif"  # or .tif??
...
# nlcd_1992 <- project(nlcd_1992, "EPSG:4326") 
...
# 4. Plot to check
# ----------------------------------------
plot(floral_layer, main = "Floral Resource Proxy: Open Habitat (NLCD 1992)")
legend("topright", legend = c("Non-floral", "Open floral habitat"), fill = c("gray", "green"))

# ----------------------------------------
# 5. climate data
# ----------------------------------------
#using same clim data because we want it to match the franklin SDM 
...
presence_df <- Vos_to2006
presence_points <- vect(presence_df, geom = c("decimalLongitude", "decimalLatitude"), crs = "EPSG:4326")  # or whatever CRS your data is in
...
# Save as GeoTIFF
output_path <- "/Users/whitneymaxfield/Desktop/Vos_2006.tif"
