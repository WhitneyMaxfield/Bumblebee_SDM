...
# Use the post 1998 data (CSV)
occ_data_post_1998 <- post_1998_occ

# Convert to SpatVector
occ_spat <- vect(occ_data_post_1998, geom = c("decimalLongitude", "decimalLatitude"), crs = "EPSG:4326")
...
# Download climate data (this is 2001-2020 clim data from worldclim v.2)
clim_2001_2020 <- worldclim_global(var = "bio", res = 2.5, path = "/Users/whitneymaxfield/Desktop/Bee_SDMs/Westerns_past&future_oregon2/", version = "2.1", years = 2001)
...
plot_maxnet_responses_to_png <- function(model, data, output_dir = "/Users/whitneymaxfield/Desktop/Bee_SDMs/Westerns_past&future_oregon2/maxent_curves_just_OR_post1998", type = "cloglog") {
...
colnames(presenceAbsenceEnvDf)
names(geographicArea) <- colnames(presenceAbsenceEnvDf)
...
png("/Users/whitneymaxfield/Desktop/Bee_SDMs/Westerns_past&future_oregon2/maxent_map_Oregon_after1998.png", width = 800, height = 600)
plot(occpredictplot, main = "Maxnet Predicted Suitability for Bombus occidentalis in Oregon After 1998")
dev.off()
...
output_path <- "/Users/whitneymaxfield/Desktop/Bee_SDMs/Westerns_past&future_oregon2/Occidentalis_post1998prediction_Oregon.tif"
...
write.csv(OccDataNotCoords, 
          "/Users/whitneymaxfield/Desktop/Bee_SDMs/Post_presence_points.csv", 
          row.names = FALSE)

write.csv(backgroundPoints, 
          "/Users/whitneymaxfield/Desktop/Bee_SDMs/Post_background_points.csv", 
          row.names = FALSE)
